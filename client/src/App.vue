<template>
  <div class="relative p-6 max-w-xl mx-auto text-center text-stone-700 dark:text-stone-100 text-3xl">
    ...
    <button @click="toggleMute" class="absolute cursor-pointer top-0 right-0 w-12 h-12 content-center text-stone-400 hover:text-stone-700 dark:hover:text-stone-100 transition-colors duration-150 ease-out" :aria-label="`${audioMuted ? 'Unmute' : 'Mute'} Sound Effects`">
